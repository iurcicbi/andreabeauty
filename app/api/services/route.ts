 ...
 * 
 * GET /api/services - Lista tutti i servizi attivi
 * POST /api/services - Crea un nuovo servizio (solo specialist)
 */
 ...
 * Solo per utenti con ruolo 'specialist'
 */
export async function POST(req: NextRequest) {
  try {
    // Verifica che l'utente sia uno specialist
