      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-surface-container-low border border-outline/20 overflow-hidden">
          ...
          <div className="bg-primary p-8 text-center">
            <h1 className="font-headline-md text-headline-md text-black mb-2">
          ...
          <div className="p-8">
            <div className="bg-surface-variant/30 p-6 mb-6">
              <h2 className="font-headline-sm text-headline-sm mb-6 text-center text-black">
                Detalii Programare
              </h2>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-surface border border-outline/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-label-md text-label-md text-black">Specialist</p>
                      <p className="font-body-md text-body-md font-bold text-black">{specialistNome}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-surface border border-outline/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-label-md text-label-md text-black">Serviciu</p>
                      <p className="font-body-md text-body-md font-bold text-black">{servizio}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-surface border border-outline/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-label-md text-label-md text-black">Data</p>
                        <p className="font-body-md text-body-md font-bold text-black">{dataFormattata}</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 bg-surface border border-outline/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-label-md text-label-md text-black">Ora</p>
                        <p className="font-body-md text-body-md font-bold text-black">{ora}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {sede && (
                  <div className="p-4 bg-surface border border-outline/10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-label-md text-label-md text-black">Locație</p>
                        <p className="font-body-md text-body-md font-bold text-black">{sede}</p>
                        {postazione && <p className="font-label-md text-label-md text-black">Postație: {postazione}</p>}
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="bg-primary-container/20 border-l-4 border-primary p-4 mb-6">
              <h3 className="font-headline-sm text-[18px] text-black mb-3 flex items-center gap-2">
              ...
              <ul className="font-body-md text-body-md text-black space-y-2">
            ...
            <div className="space-y-3">
              <Link
                href="/"
                className="block w-full bg-primary text-black text-center py-4 font-label-caps text-label-caps uppercase tracking-widest hover:opacity-90 transition-all"
              >
                Înapoi la Acasă
              </Link>
              <Link
                href="/booking"
                className="block w-full bg-surface border-2 border-outline/30 text-black text-center py-4 font-label-caps text-label-caps uppercase tracking-widest hover:bg-surface-container-highest transition-all"
              >
            ...
            <div className="mt-6 text-center">
              <p className="font-body-md text-body-md text-black">
                ...
                <span className="font-bold text-black">{countdown}</span> secunde
              </p>
              <button
                onClick={() => router.push('/')}
                className="font-label-caps text-label-caps text-black underline mt-1"
              >
                Mergi acum
              </button>
            </div>
        ...
        <div className="text-center mt-8">
          ...
          <p className="font-label-md text-label-md text-black opacity-70 mt-2">
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-surface flex items-center justify-center">
        <p className="font-body-md text-black">Se încarcă...</p>
      </div>
    }>
      <ContenutoSuccesso />
    </Suspense>
